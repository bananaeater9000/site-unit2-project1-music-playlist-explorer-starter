...
**Walkthrough video:** [Music Playlist Explorer Walkthrough](https://www.loom.com/share/5c96b136c5ad402eaf1ea0bef938f735)

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

Yes the topics discussed in labs did prepare me for the assignment. Specifically, implementing an API key and using the API to connect with an AI model. It was difficult at first getting it to work, but seeing a demo from the instructor helped me understand how to actually execute it. 

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would add functionality to the song playing or the music being able to play in the music app. 

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

The specific sorting and changing to dark mode features working. The flexbox sometimes interacted with other content in ways I didn't want it to such as pushing stuff outside a box. I noticed how nice my peers UI design, they really went the extra mile to make things look nice. 
